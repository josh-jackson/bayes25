...
Most often we look at coefficients to interpret our models. This is fine, but it sub-optimal for a number of reasons, especially when we get to more complex models. 
We need to define the specific empirical quantity that would shed light on our research question. The *estimand* is the object of inquiry—it is the precise quantity about which we marshal data to draw an inference.
