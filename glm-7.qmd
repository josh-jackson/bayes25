...
## Negative binomial or the "Gamma Poisson"

-   Used for modeling count data where the variance exceeds the mean, known as overdispersion. Often for the number of failures before a specified number of successes in Bernoulli trials
